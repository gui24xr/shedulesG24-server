...
import { shedulesSchema } from "../schemas/shedules.schemas.js";
import { shedulesRepository } from "../repositories/shedules.repository.js";



class ShedulesControllers extends RequestControllers{
...
export const shedulesControllers = new ShedulesControllers({
    repository: shedulesRepository,
    validateSchema: shedulesSchema
})
