...
import { companyBranchSchema } from "../schemas/companyBranchs.schema.js";
import { companyBranchsRepository } from "../repositories/companyBranchs.repository.js"



class CompanyBranchsControllers extends RequestControllers{
...
export const companyBranchsControllers = new CompanyBranchsControllers({
    repository: companyBranchsRepository,
